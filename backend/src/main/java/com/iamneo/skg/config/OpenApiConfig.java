...
@OpenAPIDefinition(info = @Info(contact = @Contact(name = "Siva Prasanna", email = "sivaprasanna.s@iamneo.ai", url = "https://some-url.com"), description = "This is open api documentation for e_commerce", title = "ECommerce", version = "1.0", license = @License(name = "MIT", url = "https://some-url.com"), termsOfService = "Terms of service"), servers = @Server(description = "DEV ENV", url = MyConstant.DEFAULT_URL))
